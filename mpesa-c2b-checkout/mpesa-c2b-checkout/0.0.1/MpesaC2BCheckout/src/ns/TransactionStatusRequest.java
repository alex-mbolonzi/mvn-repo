...
public class TransactionStatusRequest implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("tns:ns",
			"transactionStatusRequest", "ns1");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":transactionStatusRequest", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "transactionStatusRequest",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TransactionStatusRequest parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			TransactionStatusRequest object = new TransactionStatusRequest();
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"transactionStatusRequest".equals(type)) {
							...
							return (TransactionStatusRequest) ns.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
