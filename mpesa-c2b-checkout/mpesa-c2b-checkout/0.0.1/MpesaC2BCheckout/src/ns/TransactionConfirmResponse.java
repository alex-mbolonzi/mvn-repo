/**
 * TransactionConfirmResponse.java
 *
...
/**
 * TransactionConfirmResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class TransactionConfirmResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("tns:ns",
			"transactionConfirmResponse", "ns1");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":transactionConfirmResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "transactionConfirmResponse",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TransactionConfirmResponse parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			TransactionConfirmResponse object = new TransactionConfirmResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"transactionConfirmResponse".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (TransactionConfirmResponse) ns.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
