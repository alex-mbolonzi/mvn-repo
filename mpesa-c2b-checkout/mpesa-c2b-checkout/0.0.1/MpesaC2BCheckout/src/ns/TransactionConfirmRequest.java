...
/**
 * TransactionConfirmRequest bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class TransactionConfirmRequest implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("tns:ns",
			"transactionConfirmRequest", "ns1");
	 ...
	 */
	protected boolean localTRX_IDTracker = false;

	public boolean isTRX_IDSpecified() {
		return localTRX_IDTracker;
	}
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localMERCHANT_TRANSACTION_IDTracker = false;

	public boolean isMERCHANT_TRANSACTION_IDSpecified() {
		return localMERCHANT_TRANSACTION_IDTracker;
	}
	...
	public void setMERCHANT_TRANSACTION_ID(java.lang.String param) {
		localMERCHANT_TRANSACTION_IDTracker = param != null;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":transactionConfirmRequest", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "transactionConfirmRequest",
						xmlWriter);
			}

		}
		if (localTRX_IDTracker) {
			namespace = "";
		...
		if (localMERCHANT_TRANSACTION_IDTracker) {
			namespace = "";
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TransactionConfirmRequest parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			TransactionConfirmRequest object = new TransactionConfirmRequest();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"transactionConfirmRequest".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (TransactionConfirmRequest) ns.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
