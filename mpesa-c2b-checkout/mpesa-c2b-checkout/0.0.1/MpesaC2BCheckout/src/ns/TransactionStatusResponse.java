...
public class TransactionStatusResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("tns:ns",
			"transactionStatusResponse", "ns1");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":transactionStatusResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "transactionStatusResponse",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TransactionStatusResponse parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			TransactionStatusResponse object = new TransactionStatusResponse();
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"transactionStatusResponse".equals(type)) {
							...
							return (TransactionStatusResponse) ns.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
